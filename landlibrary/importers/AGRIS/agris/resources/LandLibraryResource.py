...
class LandLibraryResource(object):
    ...
    def as_csv_line(self):
        ...
        return  u";".join((u'"{}"'.format(xstr(item))) for item in [self.get_id(), 
                                                                    ...
                                                                    self._get_string_csv(self.get_subtitle()),
                                                                    self._get_string_csv(self.get_description()),
                                                                    self._get_list_for_csv(self.get_authors(),"\n"),
                                                                    self._get_list_for_csv(self.get_corporate_authors()),
                                                                    self._get_list_for_csv(self.get_publishers()),
                                                                    self.get_data_provider(), 
                                                                    self.get_date(), 
                                                                    self._get_list_for_csv(self.get_language()), 
                                                                    self._get_list_for_csv(self.get_concepts()),
                                                                    self._get_list_for_csv(self.get_themes()),
                                                                    self._get_list_for_csv(self.get_overarching_categories()), 
                                                                    ...
                                                                    self.get_image(), 
                                                                    self.get_license(), 
                                                                    self.get_copyright_details(), 
                                                                    self.get_number_pages()]) + u'\n'
